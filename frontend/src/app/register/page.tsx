...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Standard fetch to our Express Register API
      ...
      if (!res.ok) {
        // Render either the array of express-validator errors or a generic error string
        const errMsg = data.errors ? data.errors[0].msg : data.error;
        throw new Error(errMsg || 'Registration failed');
      }

      // Success! Auto-login the user by storing token
